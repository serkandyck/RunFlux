...
# Tüm URL'leri içeren tek string
# Not: URL'lerin boşluk ile ayrıldığını varsayıyoruz
url_string="${IMAGES}"

# İndirilen dosyaların kaydedileceği dizin
download_dir="/workspace/ai-toolkit/images"

# İndirme dizinini oluştur (eğer yoksa)
